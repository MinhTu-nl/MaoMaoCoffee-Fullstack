        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg w-full max-w-2xl mx-4 overflow-hidden">
                                    ...
                                    <div className="flex-1 space-y-4">
                                        <div className="space-y-1">
                                            ...
                                            <input
                                                ...
                                                readOnly
                                                className="w-full px-3 py-2 text-sm border border-gray-200 rounded-lg bg-white focus:ring-1 focus:ring-blue-950 focus:border-transparent transition-all duration-200"
                                            />
                                        </div>
                ...
                <div className="bg-gray-50 px-6 py-4 flex justify-end">
                    <button
                        onClick={handleClose}
                        className="px-6 py-2 bg-blue-950 text-white rounded hover:bg-[#1a1f2e] transition-colors"
                    >
                        Đóng
                    </button>
                </div>
